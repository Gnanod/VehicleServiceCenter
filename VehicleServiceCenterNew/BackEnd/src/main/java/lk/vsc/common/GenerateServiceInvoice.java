...
public class GenerateServiceInvoice {
    ...
    public static void main(String[] args) {
        ...
        String pdfFilename = "";
        GenerateServiceInvoice generateInvoice = new GenerateServiceInvoice();
    ...
    private void createPDF (String pdfFilename){
        ...
        try {
          //  String path = "docs/" + pdfFilename;
            String path = "C:/Users/" + System.getProperty("user.name") + "/Documents/" + pdfFilename;
...
//            cb.lineTo(480,760);
            ...
            createHeadings(cb,422,743,"Service Invoice Number");
            createHeadings(cb,422,723,"Service Invoice Date");
//            createHeadings(cb,422,703,"Invoice Date");
            ...
            createHeadings(cb,22,633,"Service");
            createHeadings(cb,52,633,"price");
...
//        }
    ...
    private void generateHeader(Document doc, PdfContentByte cb)  {
        ...
        try {
            ...
            createHeadings(cb,200,750,"Turismo Vehicle Service Center");
            createHeadings(cb,200,735,"Address Line 1");
            createHeadings(cb,200,720,"Address Line 2");
            createHeadings(cb,200,705,"Anuradhapura");
            createHeadings(cb,200,690,"Srilanka");

            createHeadings(cb,522,743,"ABC0001");
            createHeadings(cb,522,723,"123456");
