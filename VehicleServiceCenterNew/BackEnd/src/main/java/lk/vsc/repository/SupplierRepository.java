...
public interface SupplierRepository extends JpaRepository<Supplier,Integer> {
    ...
    @Query(value = "from Supplier where agentName   Like CONCAT('%',:supplierId,'%') or supplierId Like CONCAT('%',:supplierId,'%') or companyName Like CONCAT('%',:supplierId,'%') or phoneNumber Like CONCAT('%',:supplierId,'%')")
