...
export class CustomerVehicleUpdateComponent implements OnInit {
  ...
  public constructor(public vehicleClassService: VehicleClassServiceService, private makeService: MakeServiceServiceService, private vehicleService: VehicleServiceService, private customerService: CustomerServiceService, private make_model_service: MakeModelServiceService) {
  }
