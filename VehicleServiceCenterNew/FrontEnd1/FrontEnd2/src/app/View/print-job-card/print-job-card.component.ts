...
export class PrintJobCardComponent implements OnInit {
  ...
  constructor(private vehicleservice: VehicleServiceService, private jobService: JoborderServiceService, private serviceJobService: ServicejobServiceService) {
  }
  ...
  printJobOrder() {
    ...
    this.serviceInvoice.presentOdoMeter = this.presentOdoMeter;
    ...
    if (this.searchVehicleNumber != null) {
      ...
      if(this.presentOdoMeter !=null){
        ...
        Swal.fire({
          position: 'top-end',
          icon: 'error',
          title: 'Please fill  Present Odo meter Field.',
          showConfirmButton: false,
          timer: 1500
        })
      }
